...
namespace FruitVegBasketMaui.Api.Data.Migrations
{
    ...
    [Migration("20250312141920_fixedCartQuantityName")]
    partial class fixedCartQuantityName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FruitVegBasketMaui.Api.Data.Entities.Address", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FruitVegBasketMaui.Api.Data.Entities.Category", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FruitVegBasketMaui.Api.Data.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FruitVegBasketMaui.Api.Data.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FruitVegBasketMaui.Api.Data.Entities.Role", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("FruitVegBasketMaui.Api.Data.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FruitVegBasketMaui.Api.Data.Entities.Address", b =>
                {
                    b.HasOne("FruitVegBasketMaui.Api.Data.Entities.User", "User")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("FruitVegBasketMaui.Api.Data.Entities.OrderItem", b =>
                {
                    b.HasOne("FruitVegBasketMaui.Api.Data.Entities.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FruitVegBasketMaui.Api.Data.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("FruitVegBasketMaui.Api.Data.Entities.Product", b =>
                {
                    b.HasOne("FruitVegBasketMaui.Api.Data.Entities.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("FruitVegBasketMaui.Api.Data.Entities.User", b =>
                {
                    b.HasOne("FruitVegBasketMaui.Api.Data.Entities.Role", "Role")
                        .WithMany()
